...
class InteractiveOperate(object):
	...
	def Setting(self,Prs3d_TypeOfHighlight):
		...
		asp.SetTypeOfMarker(1)
		#SetTypeOfMarker(Prs3d_TypeOfMarker::Prs3d_TOM_CIRCLE)
		asp.SetScale( 2)
		HighlightStyle.SetPointAspect(asp)
		
		self.parent.Displayshape_core.canva._display.Context.SetHighlightStyle(Prs3d_TypeOfHighlight)
