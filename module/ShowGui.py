...
class Ui_MainWindow(MainGui.Ui_MainWindow):
	def __init__(self):
		...
		self.parameter_panel=ModelTree.parameter_panel(self)
		...
		self.parameter_items = QDockWidget('参数设置面板', self)  # 新建QDockWidget
		self.addDockWidget(Qt.RightDockWidgetArea, self.parameter_items)  # 在主显示区域右侧显示
		self.parameter_items.setMinimumWidth(300)# 设置最小大小
		self.parameter_items.setWidget(self.parameter_panel.tableWidget)
		self.parameter_items.close()
		#self.parameter_items.setMaximumWidth(250)
